...
And examples that combine resource state with **live Prometheus metrics**:
  ...
  - [Restart Memory-Saturated Pods](https://gianlucam76.github.io/k8s-cleaner/getting_started/examples/metrics/metric_based_selection): Delete Pods when their memory working set exceeds 90% of the configured limit.
...
[![Star History Chart](https://star-history.dera.page/svg?repos=gianlucam76/k8s-cleaner&type=Date)](https://star-history.dera.page/#gianlucam76/k8s-cleaner&Date)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/vtmocanu"><img src="https://avatars.githubusercontent.com/u/1106868?v=4?s=100" width="100px;" alt="Vlad Mocanu"/><br /><sub><b>Vlad Mocanu</b></sub></a><br /><a href="#ideas-vtmocanu" title="Ideas, Planning, & Feedback">🤔</a> <a href="#blog-vtmocanu" title="Blogposts">📝</a> <a href="https://github.com/gianlucam76/k8s-cleaner/commits?author=vtmocanu" title="Code">💻</a></td>
    </tr>
  </tbody>
</table>
